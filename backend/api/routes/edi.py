...
from dependencies import get_master_edi_blob_client, get_azure_client
...
async def upload_edi_report(
    ...
    return await upload_service(file, user, blob_client)
...
async def get_dashboard_data(
    ...
    return await get_dashboard_data_service(blob_client)
...
async def analyze_edi_range(
    ...
    return await analyze_edi_range_service(request, user, azure_client)
...
async def export_edi_range(request: EDIAnalysisRequest, user: Dict = Depends(require_unc_email)):
    ...
    return await export_edi_range_service(request, user)
